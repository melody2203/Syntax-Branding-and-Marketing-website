        ...
        <main className="min-h-screen bg-[#020202] text-white pt-32 pb-24">
            <div className="container mx-auto px-6 md:px-12">
                <div className="max-w-4xl">
                    ...
                    <div className="w-24 h-24 bg-[#D1FF00] grid grid-cols-2 grid-rows-2 mb-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-16">
                        <div className="p-8 border border-white/10 bg-white/5 rounded-2xl">
                            <h3 className="text-2xl font-semibold mb-4 text-white">Startup Speed</h3>
                            <p className="text-gray-400">We move fast. Our agile methodology ensures rapid prototyping and continuous delivery, getting your product to market quicker.</p>
                        </div>
                        <div className="p-8 border border-white/10 bg-white/5 rounded-2xl">
                            <h3 className="text-2xl font-semibold mb-4 text-white">Enterprise Quality</h3>
                            <p className="text-gray-400">Despite our speed, we never compromise on quality. We enforce strict coding standards and comprehensive testing.</p>
                        </div>
                    </div>
