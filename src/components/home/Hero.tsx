...
export function Hero() {
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center pt-20 overflow-hidden bg-white">
            {/* Abstract Background Elements - Subtle Blue Glows adjusted for white bg */}
            <div className="absolute inset-0 z-0 opacity-20">
                <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-blue-100 rounded-full blur-[160px]" />
                <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-blue-50 rounded-full blur-[160px]" />
            </div>
            ...
            <div className="container relative z-10 mx-auto px-6 md:px-12 text-center mt-12">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-10">
                        <Link
                            href="#contact"
                            className="w-full sm:w-auto px-10 py-4 rounded-full bg-blue-600 text-white font-semibold hover:bg-blue-500 transition-colors flex items-center justify-center gap-2 shadow-[0_10px_30px_rgba(0,102,255,0.15)] hover:shadow-[0_15px_40px_rgba(0,102,255,0.25)]"
                        >
                            Start a Project
                            <ArrowRight size={18} />
                        </Link>
